      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            Founded in 1895 in Austria, the company designs, manufactures and markets high-quality crystals, genuine gemstones and created stones as well as finished products such as jewelry, accessories and lighting. 
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              We endeavour to create our products minimizing excess; however, we sometimes end up with more crystals than we need. 
              </p>
            </article>
            <article>
              <svg
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
              These crystals are a precious resource that we don’t want to go to waste. We are committed to reigniting these crystals in various formats.
              </p>
            </article>
          </div>
        </div>
