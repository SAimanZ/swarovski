...
const testimonials = [
  {
    ...
    company: "Swarovski",
    content:
      "These crystals are a precious resource that we don’t want to go to waste. We are committed to reigniting these crystals in various formats, without compromising on quality.",
    categories: [1, 3, 5],
  },
  {
